...
GLuint Shader::CreateProgram(const std::string& vertex_shader, const std::string& fragment_shader) {
...
GLuint Shader::CreateProgramFromSource(const std::string& vertex_shader, const std::string& fragment_shader) {
